...
namespace mechmania {
    ...
    class Drivetrain {
        ...
        protected:                                        
            ...
            uint8_t kfl2 = 0;
            int deadzone = 40;
            std::array<int,4> invertDir = {1,1,1,1};
    };


    class Arcade: public Drivetrain {
        public: 
            ...
            void updateMotor(int joyX1, int joyX2, int joyY, int joyY2) override;
    };
    ...
    class HeadlessMecanum: public Drivetrain {
        public:
            HeadlessMecanum(uint8_t kbr1, uint8_t kbr2, uint8_t kbl1, uint8_t kbl2, uint8_t kfr1, uint8_t kfr2, uint8_t kfl1, uint8_t kfl2, OrientationProvider* orientProvider, int deadzone = 40);
            void updateMotor(int joyX1, int joyX2, int joyY, int joyY2) override; // Must be in range (-512,512)
        private:
           OrientationProvider* orientProvider;
           std::array<std::array<float,4>,360> LUT;
    };
